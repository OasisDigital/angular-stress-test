...
function generateAppModule(bazel: boolean) {
  let ts = `// Code generated by angular-stress-test
...
export function generate(nModules, nComponents, deterministic, bazel) {
